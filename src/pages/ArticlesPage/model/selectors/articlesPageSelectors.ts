...
import { ArticleEnum, ArticleSortField, ArticleView } from 'entities/Article';
...
export const getArticlesPageInitedState = (state: StateSchema) => state.articlesPage?._initedState;
...
export const getArticlesPageType = (state: StateSchema) => state.articlesPage?.type ?? ArticleEnum.ALL;
