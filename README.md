...
Ссылка на сайт: https://dreamy-mochi-1a2ea4.netlify.app/
...
- [Работа с данными (Redux toolkit, RTK query)](#работа-с-данными-Redux-toolkit-RTK-query)
- [Команды для запуска проекта](#команды-для-запуска-проекта)
- [Архитектура проекта (FSD)](#архитектура-проекта-fsd)
- [Пример использования в проекте](#пример-использования-в-проекте)
- [Оптимизация производительности](#оптимизация-производительности)
- [Линтинг (Stylelint, Eslint)](#линтинг-stylelint-eslint)
- [Форматирование кода (Prettier)](#форматирование-кода-prettier)
- [Storybook](#storybook)
- [Тестирование (Jest, RTL, Cypress)](#тестирование-jest-rtl-cypress)
  - [Unit тесты](#unit-тесты)
  - [Скриншотное тестирование](#скриншотное-тестирование)
  - [E2E тестирование](#e2e-тестирование)
- [Сборщики (Webpack, vite)](#сборщики-webpack-vite)
- [Инструменты для поиска ошибок](#инструменты-для-поиска-ошибок)
...
### Работа с данными (Redux toolkit, RTK query)

- `Redux toolkit` Взаимодействие с данными
